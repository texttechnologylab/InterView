...
function publishOwnFeed(useAudio) {
	...
	// Get selected video resolution (default to fhdres if not set)
	let videoResolution = $('#video-resolution').val() || 'fhdres';
	
	tracks.push({ type: 'video', capture: videoResolution, recv: false,
